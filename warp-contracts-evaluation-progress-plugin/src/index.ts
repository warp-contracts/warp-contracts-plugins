...
export type EvaluationProgressPluginInput = { contractTxId: string, currentInteraction: number, allInteractions: number, lastInteractionProcessingTime: number };

export class EvaluationProgressPlugin
  implements WarpPlugin<EvaluationProgressPluginInput, void> {
